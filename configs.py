...
model_type2path = {
    ...
    "deberta":"/home/hnu1/.ss/temp/5_0.9659036356185235_0.9320601526236012_0.9030142463770782_model"
    # "xlm": "",
...
eval_configs = {
    ...
    "environment": dict(
        ...
        model_path="./data/models/trained_food_" + model_type + "/",
        dic_path="./data/dic/dic.json",
        terms="./data/eval/environment_eval.terms",
        output="./data/result/environment.results",
        # config
        padding_max=150,
        model_type=model_type
    )
